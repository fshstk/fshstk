...
{
  const auto percentLabel = fsh::FloatParam::Attributes{}.withLabel("%");
  const auto semitonesLabel = fsh::FloatParam::Attributes{}.withLabel("semi");
  const auto centsLabel = fsh::FloatParam::Attributes{}.withLabel("cents");
  const auto millisecondsLabel = fsh::FloatParam::Attributes{}.withLabel("ms");
  const auto decibelsLabel = fsh::FloatParam::Attributes{}.withLabel("dB");
  const auto herzLabel = fsh::FloatParam::Attributes{}.withLabel("Hz");
  ...
  return {
    ...
    fsh::FloatParam{
      ...
      .range = fsh::FloatParam::Range{ -50.0f, 50.0f, 0.1f, 0.3f, true },
      .defaultVal = 0.0f,
    ...
    fsh::FloatParam{
      .id = "glide_bend",
      .name = "Glide Bend",
      .range = fsh::FloatParam::Range{ -36.0f, 36.0f, 0.01f, 0.4f, true },
      .defaultVal = 0.0f,
      .attributes = semitonesLabel,
    }
      .create(),
